    ...
    <body>
        <div class="space">
            ...
            <div class="link_footer pb-3">
                <div class="row w-100 ">
                    <div class="col-lg-12 pt-5 text-center">
                        ...
                        <a href="" class="text-orange link_4 link_false b">Pc Portable</a>
                    </div>
                </div>
            </div>       
            <div class="libelle text-vert text-center">
                ...
                <h64 class="text-muted">Pc Portable</h6>
            </div>
                                    ...
                                    <div class="col-lg-6 border-bottom text-center border-bottom fileImage py-3 box-photo">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <img src="assets/img/elements/default/laptop.png" alt="" class="x-small-max-height x-small-img">
            ...
            $(()=>{
                ...
                $(".btn-valider").click(function(){
                    ...
                    if (vide==0) {
                        ...
                        $('.box-photo img').attr("src", "assets/img/elements/default/laptop.png")
