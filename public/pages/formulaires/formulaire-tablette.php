            ...
            <div class="link_footer">
                <div class="row w-100 pb-3">
                    <div class="col-lg-12 pt-5 text-center">
                        ...
                        <a href="" class="text-orange link_4 link_false b">Tablette</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input list="brow" type="text" class="form-control p-4 designed" id="marque" required>
                                    <?php 
                            ...
                            <div class="col-lg-6">
                                <div class="form-group p-0">
                                    ...
                                    <input type="text" class="form-control designed required number" id="id" required>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control designed required number" id="confirm_id" required>
                                    <span class="labError text-danger w-100 p-2 b"></span>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-lg-6 border-bottom text-center fileImage pb-3 box-id" >
                                        <div class="row">
                                            <div class="col-12">
                                    ...
                                    <div class="col-lg-6 border-bottom text-center border-bottom fileImage py-3 box-phone-1">
                                        <div class="row">
                                            <div class="col-12">
                                                <h6>Photo téléphone recto (obligatoire)</h6>
                                                <input type="hidden" id="filename">
