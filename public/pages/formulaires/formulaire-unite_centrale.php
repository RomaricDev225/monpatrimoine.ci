    ...
    <body>
        <div class="space">
            ...
            <div class="link_footer pb-3">
                <div class="row w-100 ">
                    <div class="col-lg-12 pt-5 text-center">
                        ...
                        <a href="" class="text-orange link_4 link_false b">Unité centrale</a>
                    </div>
                </div>
            </div>       
            <div class="libelle text-vert text-center">
                ...
                <h64 class="text-muted">Unité centrale</h6>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group p-0">
                                    ...
                                    <input type="text" class="form-control p-4 designed required" id="serial" required>
                                    <span class="labError text-danger w-100 p-2 b"></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group p-0">
                                    <label for="" class="b">Adresse Mac</label>
                                    <input type="text" class="form-control p-4 designed required" id="mac" required>
                                    <span class="labError text-danger w-100 p-2 b"></span>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-lg-6 border-bottom text-center border-bottom fileImage py-3 box-photo">
                                        <div class="row">
                                            <div class="col-12">
                                                <h6>Photo de l'ordinateur portable (obligatoire)</h6>
                                                <input type="hidden" id="filename">
                                                <img src="assets/img/elements/default/unite.png" alt="" class="x-small-max-height x-small-img">
            ...
            $(()=>{
                ...
                $(".btn-valider").click(function(){
                    ...
                    if (vide==0) {
                        ...
                        $('.box-photo img').attr("src", "assets/img/elements/default/unite.png")
