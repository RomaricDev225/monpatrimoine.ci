    ...
    <body>
        <div class="space">
            ...
            <div class="space-body">
                ...
                <div class="formulaire container p-5 pt-3">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-lg-6 border-bottom text-center border-bottom fileImage py-3 box-photo">
                                        <div class="row">
                                            <div class="col-12">
                                                <h6>Photo du copieur (obligatoire)</h6>
                                                <input type="hidden" id="filename">
                                                <img src="../../assets/img/elements/default/copieur.jpg" alt="" class="x-small-max-height x-small-img">
                        ...
                        $.post("traitements/query.php",{rqt:sql}, function (resultat) {
                            if (resultat==1) {
                                ...
                                for (let x = 0; x < 2; x++) {
                                    ...
                                    $('.box-photo img').attr("src", "../../assets/img/elements/default/copieur.jpg")
