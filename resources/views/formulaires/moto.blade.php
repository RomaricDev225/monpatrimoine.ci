                        ...
                        <div class="row" id="field">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control designed p-4 required" id="num_chassis" required>
                                    <span class="labError text-danger w-100 p-2 b"></span>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group p-0">
                                    ...
                                    <input type="text" class="form-control designed p-4 required" maxlength="17" id="immat" required>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 border-bottom text-center fileImage box-id" >
                                        <div class="row d-flex justify-content-center">
                                            <div class="col-12">
                                                <h6>Photo de l'engin (obligatoire)</h6>
                                                <input type="hidden" id="filename">
                                                <img src="../../assets/img/elements/default/moto-ico.png" alt="" class="x-small-max-height x-small-img">
                ...
                $(".btn-valider").click(function(){
                    ...
                    if (etat.includes("disabled")==false) {                      
                        ...
                        if (vide==0) {
                            ...
                            var ident = $("#immat").val() + "~" + $("#num_chassis").val()
                            var designation = $("#designation").val()
                            var marque = $("#marque").val()
                            var categ ="MOTO"
                            var client = $("#ident_client").val()
                            var aujourdhui = dateActuelle()
                            var nameFileTab = [categ + "_Eng_", categ + "_recu_"]
