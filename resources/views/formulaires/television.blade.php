    ...
    <body>
        <div class="space">
            ...
            <div class="libelle text-vert text-center">
                ...
                <h64 class="text-muted">Télévision</h6>
            </div>
            ...
            $(()=>{
                ...
                $(".btn-valider").click(function(){
                    ...
                    if (vide==0) {
                        ...
                        var sql = 'select categorie from where codeMarque="' + designation + '" and categorie LIKE "%' + categ + '%"'
                        $.post("../../traitements/retrieve.php",{rqt:sql, nbreCol:1}, function (rest) {
                            if (rest.includes("#$")==true) {
                                ...
                                $.post("../../traitements/query.php",{rqt:sql}, function (resultat) {
                                    if (resultat==1) {
                                        ...
                                        sql = 'update marque set categorie="' + 
