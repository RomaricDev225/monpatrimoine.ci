                        ...
                        <div class="row" id="field">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group p-0">
                                    ...
                                    <input type="text" class="form-control designed p-4 required number" maxlength="17" id="id" required>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control designed p-4 required number" maxlength="17" id="confirm_id" required>
                                    <span class="labError text-danger w-100 p-2 b"></span>
                                </div>
                            </div>
                        </div>
                ...
                $(".btn-valider").click(function(){
                    ...
                    if (etat.includes("disabled")==false) {                      
                        ...
                        if (vide==0) {
                            ...
                            $("#image").closest(".fileImage").find("p.alert-danger").removeClass("d-none").text("Veuillez choisir une image")
